...
<ProjectCard
  ...
  link="https://github.com/Jdubz"
  bgImage="/testcode.png"
>
  Production-scale web applications, cloud infrastructure, and developer tooling. React/Angular frontends, Node.js/Python backends, Kubernetes orchestration on GCP/AWS, CI/CD pipelines, and shared libraries for observability and security. Check out my GitHub for open-source contributions and portfolio projects.
</ProjectCard>
<ProjectCard

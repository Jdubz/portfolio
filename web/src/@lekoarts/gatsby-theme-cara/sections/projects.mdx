...
>
  This site. Gatsby + React + TypeScript + Theme UI with a clean component system and parallax touches, containerized and deployed on GCP. Fast, observable, and easy to extend.
</ProjectCard>
<ProjectCard

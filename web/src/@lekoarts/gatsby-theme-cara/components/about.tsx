...
const About = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <section data-screenshot-section="about" className="section has-icons" data-icon-preset="about" aria-label="About">
    ...
    <Divider speed={0.1} offset={offset} factor={factor} className="iconCanvas">
      <UpDown>
        <Svg icon="box" hiddenMobile width={12} color="icon_blue" left="50%" top="75%" />
        <Svg icon="upDown" hiddenMobile width={16} color="icon_darkest" left="70%" top="20%" />
        <Svg icon="triangle" width={16} stroke color="icon_darkest" left="25%" top="5%" />
      ...
      <UpDownWide>
        ...
        <Svg icon="circle" hiddenMobile width={12} color="icon_brightest" left="85%" top="15%" />
      ...
      <Svg icon="box" width={12} color="icon_orange" left="10%" top="10%" />
      <Svg icon="box" width={12} color="icon_darkest" left="20%" top="30%" />
      <Svg icon="hexa" width={16} stroke color="icon_darkest" left="80%" top="70%" />
    </Divider>

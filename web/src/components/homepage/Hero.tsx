  ...
  >
    ...
    <Divider speed={0.2} offset={offset} factor={factor} className="iconCanvas">
      ...
      <UpDown>
        ...
        <Svg icon="box" width={64} color="icon_darker" left="60%" top="10%" />
        <Svg icon="circle" width={96} color="icon_purple" left="15%" top="80%" />
        <Svg icon="hexa" width={80} stroke color="icon_indigo" left="85%" top="85%" />
      </UpDown>
      <UpDownWide>
        ...
        <Svg icon="circle" width={88} color="icon_teal" left="75%" top="6%" />
        <Svg icon="upDown" hiddenMobile width={64} color="icon_purple" left="45%" top="10%" />
        <Svg icon="circle" width={80} color="icon_green" left="5%" top="8%" />

        {/* Bottom cluster - rising bubbles */}
        <Svg icon="circle" width={96} color="icon_darker" left="70%" top="92%" />
        <Svg icon="wifi" width={72} stroke color="icon_blue" left="30%" top="88%" />
        <Svg icon="resistor" hiddenMobile width={80} color="icon_pink" left="40%" top="85%" />
        <Svg icon="box" hiddenMobile width={88} color="icon_purple" left="5%" top="90%" />
        <Svg icon="upDown" width={72} color="icon_teal" left="95%" top="90%" />
        <Svg icon="database" width={64} stroke color="icon_indigo" left="80%" top="82%" />
      </UpDownWide>
      {/* Mid-section - sparser, smaller bubbles for depth */}
      <Svg icon="triangle" width={48} stroke color="icon_darker" left="25%" top="45%" />
      <Svg icon="circle" width={56} color="icon_darkest" left="50%" top="55%" />
      <Svg icon="box" width={48} color="icon_darkest" left="10%" top="50%" />
    </Divider>

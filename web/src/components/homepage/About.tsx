  ...
  <section data-screenshot-section="about" className="section has-icons" data-icon-preset="about" aria-label="About">
    ...
    <Divider speed={0.1} offset={offset} factor={factor} className="iconCanvas">
      ...
      <UpDown>
        ...
        <Svg icon="triangle" width={88} stroke color="icon_brightest" left="25%" top="8%" />
      ...
      <Svg icon="cross" width={48} stroke color="icon_teal" left="95%" top="50%" />
      <Svg icon="wifi" width={56} color="icon_indigo" left="70%" top="55%" />
    </Divider>
